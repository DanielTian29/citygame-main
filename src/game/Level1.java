...
public class Level1 extends GameLevel{
    ...
    private static final BodyImage PlatformImage0 =
            new BodyImage("data/FirePlatforms/Platform20.png", 2f); // used to be platform 7 4.77f
    private static final BodyImage PlatformImage1 =
            new BodyImage("data/FirePlatforms/Platform15.png", 2f); // used to be platform 8 4.83f
    private static final BodyImage PlatformImage2 =
            new BodyImage("data/FirePlatforms/Platform10.png", 2f); // used to be platform 1 2.94f
    private static final BodyImage PlatformImage3 =
            new BodyImage("data/FirePlatforms/Platform5.png", 2f); // used to be platform 2 3.99f
    private static final BodyImage PlatformImage4 =
            new BodyImage("data/FirePlatforms/Platform2.png", 2f); // used to be platform 5 4.77f
    ...
    static {
        try {
            levelMusic = new SoundClip("data/Audio/level1Music.wav");
     ...
     * coordinates is a couple spaces left or right of the previous platform, continues in the y direction,
    ...
    public Level1(Game game){
        ...
        for (float[] floats : cords) {
            if (floats[0] == 0) {
                Shape shape0 = new BoxShape(20f, 1f);
                ...
                Shape shape1 = new BoxShape(15f, 1f);
                ...
                Shape shape2 = new BoxShape(10f, 1f);
                ...
                Shape shape3 = new BoxShape(5f, 1f);
                ...
                Shape shape4 = new BoxShape(2f, 1f);
    ...
    public static float[] generateCords(int i, int platform) {
        ...
        float gap;
        float randomX;
        float previousWidth = platformWidths[(int) cords[i-1][0]];
        float currentWidth = platformWidths[platform];
        ...
        gap = cords[i - 1][2] + platformHeights[platform] + rand.nextInt(8, 12);
        if (previousWidth > currentWidth) {
            originX = cords[i - 1][1] - platformWidths[(int) cords[i - 1][0]] - platformWidths[platform] - random_num;
            boundX = cords[i - 1][1] + platformWidths[(int) cords[i - 1][0]] + platformWidths[platform] + random_num;
        }
        else{
            originX = cords[i - 1][1] - platformWidths[platform] - platformWidths[(int) cords[i - 1][0]] - random_num;
            boundX = cords[i - 1][1] + platformWidths[platform] + platformWidths[(int) cords[i - 1][0]] + random_num;
        }
     ...
     */
    @Override
    public String getBg() {return "data/HellBackground.jpg";}
